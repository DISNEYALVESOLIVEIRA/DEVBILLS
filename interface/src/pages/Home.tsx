	...
	return (
		...
		<div className="bg-gray-950 min-h-screen">
			<div className="container-app">
					...
					<div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
						<div>
							...
							<h1 className="text-4xl md:text-5xl font-bold text-white  mb-6">
								Gerencie suas finanças com o <span>DevBills</span>
							</h1>
							<p className="text-lg text-white  mb-8">
								Uma plataforma simples e eficiente para controlar suas despesas e receitas. Organize suas finanças pessoais ou do sue negócio com facilidade e tenha uma visão clara de sua situação financeira.
							</p>
				...
				<section className="py-12 md:py-20 bg-gray-900 rounded-xl">
					<div className="container-app">
						<div className="text-center mb-12">
							<h2 className="text-3 font-bold text-white mb-4">Recursos do DevBills</h2>
							<p className="text-lg text-white max-w-2lx mx-auto">Nossa plataforma oferece tudo o que você precisa para manter suas finanças
								organizadas.</p>
						</div>
				...
				<section className="py-12 md:py-20 bg-gray-900 rounded-xl text-center">
					<div className="bg-gray-900 p-8  md:p12 rounded-xl shadow-md text-center border border-gray-700">
						<h2 className="text-2xl md:text-3xl font-bold text-white mb-4" >
							Pronto para organizar suas finanças? Comece agora mesmo com o DevBills.
						</h2>
						<p className="text-lg text-white text-opacity max-w-2xl mx-auto mb-8">
							{" "}
